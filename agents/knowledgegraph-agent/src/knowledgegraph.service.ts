...
export class KnowledgegraphService {
  ...
  async processAction(input: string): Promise<string> {
    try {
      ...
      const systemPrompt = "You are a Knowledge Graph AI. Identify entities and relationships (family members, assets, events) from the query and return them in JSON.\n\nUser Query/Data: " + input;
